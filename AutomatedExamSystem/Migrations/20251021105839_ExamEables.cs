...
{
    /// <inheritdoc />
    public partial class ExamEables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CandidateAttempts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CandidateAttempts_Candidates_CandidateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CandidateIdRef = table.Column<int>(type: "int", nullable: false),
                    CandidateId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamSessions_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CandidateAttemptId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CandidateAnswers_CandidateAttempts_CandidateAttemptId",
                        column: x => x.CandidateAttemptId,
                        principalTable: "CandidateAttempts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateAnswers_CandidateAttemptId",
                table: "CandidateAnswers",
                column: "CandidateAttemptId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamSessions_CandidateId",
                table: "ExamSessions",
                column: "CandidateId");
        }
